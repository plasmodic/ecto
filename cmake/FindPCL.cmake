...
foreach(component ${PCL_FIND_COMPONENTS})
  ...
  pkg_check_modules(${PC_PCL_COMPONENT} REQUIRED ${pcl_component})
  ...
  mark_as_advanced(${PCL_COMPONENT_DEFINITIONS})
	...
	elseif(PCL_COMPONENTS_VERSION AND 
			...
			message(FATAL_ERROR 
				"PCL component: ${component} should be at version ${PCL_COMPONENTS_VERSION} not ${${PC_PCL_COMPONENT}_VERSION}")
