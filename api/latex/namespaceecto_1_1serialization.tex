...
\subsubsection[{load}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Buf\-T $>$ void {\bf ecto\-::serialization\-::load} (
...
\subsubsection[{save}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Buf\-T $>$ void {\bf ecto\-::serialization\-::save} (
\begin{DoxyParamCaption}
\item[{\-Buf\-T \&}]{buf, }
\item[{const tendril \&}]{t}
\end{DoxyParamCaption}
