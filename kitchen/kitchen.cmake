...
enable_testing()
set(ecto_kitchen_SOURCE_DIR ${CMAKE_CURRENT_SOURCE_DIR}/ecto/kitchen)
...
configure_file(ecto/kitchen/util/build_as_standalones.sh.in
  ...
  @ONLY)
add_subdirectory(ecto/kitchen/doc)

string(REPLACE ";" " " KITCHEN_PROJECTS_STR "ecto;${KITCHEN_PROJECTS}")
configure_file(${ecto_kitchen_SOURCE_DIR}/util/python_path.sh.in
